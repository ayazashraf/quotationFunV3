...
<template>  
  ...
  <div>
    ...
    <div class="p-2">
      ...
      <span>          
          <a v-bind:href="'../topic/'+author.fullname.toLowerCase()+'-quotes-'+author.id" class="card-link p-0" data-toggle="popover" data-trigger="hover" v-bind:data-content="'Top 10 '+author.fullnameDisplay+' Quotes'">Top 10 {{author.fullnameDisplay}} Quotes</a> 
      </span>
      <span class="vl">
      </span>      
